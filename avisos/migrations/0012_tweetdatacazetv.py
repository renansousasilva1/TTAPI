# Generated by Django 4.2.17 on 2025-03-01 03:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('avisos', '0011_tweetdatapmerj'),
    ]

    operations = [
        migrations.CreateModel(
            name='TweetDataCAZETV',
            fields=[
                ...
                ('likes', models.IntegerField(blank=True, default=0, max_length=255, null=True)),
            ],
        ),
    ]
